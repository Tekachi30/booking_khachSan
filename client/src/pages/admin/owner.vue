            ...
            <div class=" relative shadow-md sm:rounded-lg overflow-hidden">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody v-for="(owner, index) in owners" :key="index">
                            <tr class="border-b dark:border-gray-700">
                                ...
                                <td class="px-4 py-3"> {{ owner.address }}</td>
            ...
            <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-400 sm:p-5">
                ...
                <div>
                    <div class="grid gap-4 mb-4 sm:grid-cols-2">
                        ...
                        <div>
                            <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Số điện thoại</label>
                        ...
                        <div>
                            <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Mật khẩu</label>
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            ...
            <div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <div class="flex justify-center items-center space-x-4">
                    ...
                    <button type="submit" @click="deleteOwner()"
...
export default
{
  ...
  methods: {
    ...
    async getOwner() {
       try {
           const result = await this.$axios.get('owner/get');
    ...
    async deleteOwner() {
        try {
            const result = await this.$axios.delete(`owner/delete/${this.owner.id}`);
            if (result.status === 200) {
                this.getOwner();
                this.openDelete();
                alert(result.data.message);

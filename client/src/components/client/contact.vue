<template>
    ...
    <section class=" z-10 overflow-hidden bg-white p-10 m-2">
        <div class="container ">
            <div class="flex flex-wrap -mx-4 lg:justify-between">
                ...
                <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
                    <div class="mb-12 max-w-[570px] lg:mb-0" >
                        ...
                        <p class="text-sm leading-relaxed text-body-color dark:text-dark-6 mb-9">
                            Nếu bạn có bất kỳ câu hỏi nào, đừng ngần ngại liên hệ với đội ngũ chăm sóc khách hàng
                            của chúng tôi.
                            <br/>
                            Bạn có thể liên hệ với chúng tôi qua số điện thoại, email, hoặc gửi yêu cầu trực tuyến thông qua
                            mẫu liên hệ trên trang web. Chúng tôi cam kết phản hồi mọi yêu cầu của bạn trong thời gian nhanh
                            nhất và mang đến cho bạn trải nghiệm đặt phòng trực tuyến tốt nhất.
                        </p>
                        <!--van phong-->
                ...
                <div class="w-full px-4 lg:w-1/2 xl:w-5/12">
                    <div class="relative p-8 bg-white rounded-lg shadow-lg dark:bg-dark-2 sm:p-12">
                        <div>
                            ...
                            <div class="mb-6">
                                <textarea rows="6" placeholder="Nội dung nhắn gửi"

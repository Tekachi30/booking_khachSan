    ...
    <div class="mx-auto max-w-6xl px-6 md:px-12 lg:px-6 xl:px-0">
      ...
      >
        <div aria-hidden="true" class="flex flex-col space-y-0.5">
          <div
            class="h-0 w-0 border-l-[12px] border-r-[12px] border-b-[20px] border-transparent border-b-gray-900 dark:border-b-white"
          ></div>
      ...
      <ul
        role="list"
        class="mt-12 flex flex-wrap items-center justify-center gap-4 py-4 text-gray-600 dark:text-gray-400 sm:gap-8"
      >
        <li role="listitem">
          <router-link
            to="/owner/hotel"
      ...
      <div
        class="m-auto mt-4 flex w-max items-center justify-between space-x-4 text-gray-500"
      >
        <a
      ...
      <div class="mt-12 text-center">
        <span class="text-sm tracking-wide text-gray-500"
          >Copyright © tailus 2021 - Present | All rights reserved</span
        >
      </div>
    </div>
  </footer>

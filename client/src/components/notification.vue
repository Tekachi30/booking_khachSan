                ...
                <div class="w-full p-3 mt-8 bg-white rounded flex" v-for="noti in notis">
                    ...
                    <div class="pl-3">
                        <p tabindex="0" class="focus:outline-none text-sm leading-none"><span
                                class="text-indigo-700">{{ noti.title_noti}}</span></p>
                        <p tabindex="0" class="focus:outline-none text-sm leading-none"><span
                                class="text-indigo-700">{{ noti.content_noti}}</span></p>
    ...
    methods: {
        ...
        async getNotification() {
            try {
                ...
                const result = await this.$axios.get('noti/getbyuser/' + this.user.id)
        ...
        async deleteNoti()
        {
            ...
            const id = this.notisend.id
              const result = await this.$axios.delete('noti/delete/'+id) 

<template>
  ...
  <section class="flex flex-col md:flex-row h-screen items-center">
    ...
    >
      <img
        src="https://wallpaperaccess.com/full/201088.jpg"
        alt=""
    ...
    <div
      class="bg-white w-full md:max-w-md lg:max-w-full md:w-1/2 xl:w-1/3 h-screen px-6 lg:px-16 xl:px-12 flex items-center justify-center"
    >
      <div class="w-full h-100">
        ...
        <div class="mt-6" >
          <div>
            <label class="block text-gray-700">Địa chỉ email / Tên tài khoản</label>
            <input
              type="email"
              name=""
              id=""

...
const { getHotel, addHotel, updateHotel, deleteHotel, getHotelByOwner, addImgHotel, updateImgHotel, deleteImgHotel, getHotelNon, getHotelId } = require("../controllers/hotelController");
